...
# Parsing Script – EM500-CO2 - Rev. C

This **Parsing** script is designed for the **EM500-CO2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – EM500-CO2 Rev. C

Este script de **Parsing** está diseñado para el modelo **EM500-CO2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
